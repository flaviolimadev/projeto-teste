    ...
    <section class="log-new">
        ...
        <div class="log-right">
            ...
            <form class="log-form" action="{{ route('login_required') }}" method="post">
                @csrf

                <div class="input-box-log">
                    <label for="email">Email</label>
                    <input type="email" name="email" id="email" placeholder="Seu email ou usuário" value="{{ old('email') }}">
                </div>
                ...
                <div class="esq-senha">
                    <a href="{{ route('recover') }}">Esqueci minha senha</a>
                </div>
            ...
            <div class="footer-log">
                <div class="link">
                    <p>
                        Não tem uma conta ? <a href="{{ route('register') }}">Criar aqui</a>
                    </p>
                </div>

                <p class="pref-log" style="margin-bottom: 10px;">
